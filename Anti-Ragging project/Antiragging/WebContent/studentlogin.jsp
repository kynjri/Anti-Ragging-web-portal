...
<title>Anti-Ragging Portal</title><link rel="icon" type="image/ico" href="image/iimtlogo.jpg" />
...
<div class="heading"><h1>Student Login</h1></div>
  <div class="loginbox">
   ${msg }
...
<a href="http://localhost:8081/Antiragging/studentregistration.jsp" target="_blank">Register</a>
</form>
</div>
</body>
</html>